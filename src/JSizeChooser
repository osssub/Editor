...
import java.awt.*;
public class JSizeChooser extends javax.swing.JDialog {
    ...
    public JSizeChooser(java.awt.Frame parent, Font font) {
        super(parent);
        this.font = font;
        initComponents();
    ...
    public JSizeChooser(java.awt.Frame parent) {
        super(parent);
